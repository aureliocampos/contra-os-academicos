<?php
  function autores_scripts() {
    ...
    add_action( 'wp_enqueue_scripts', 'autores_scripts' );
    // add_action('wp_ajax_load_posts_by_ajax', 'load_autores_by_ajax_callback');
    // add_action('wp_ajax_nopriv_load_posts_by_ajax', 'load_autores_by_ajax_callback');

    function load_autores_by_ajax_callback() {
